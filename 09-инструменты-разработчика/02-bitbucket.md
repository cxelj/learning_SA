...
**Сценарий:** Вы работаете в команде из 4 человек. Проект hosted на Bitbucket. Нужно организовать процесс работы с ветками и ревью.

**Задание:**
1. Опишите стратегию ветвления (Git Flow / GitHub Flow / Trunk-based), которая подходит для вашей команды. Обоснуйте.
2. Как вы называете ветки (feature/, bugfix/, hotfix/)? Приведите примеры.
3. Опишите процесс создания Pull Request: от коммита до мержа.
4. Какие checks (линтеры, тесты) вы настроите в Bitbucket Pipelines для PR?
5. Как вы решите конфликт слияния (merge conflict)?
